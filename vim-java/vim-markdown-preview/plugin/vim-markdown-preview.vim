...
function! Vim_Markdown_Preview()
  ...
  if g:vim_markdown_preview_github == 1
    call system('grip --user=fow5040 --pass=3ae28a00b8a5577e1b570639a88d2f9b778510a5 "' . b:curr_file . '" --export /tmp/vim-markdown-preview.html --title vim-markdown-preview.html')
...
function! Vim_Markdown_Preview_Local()
  ...
  if g:vim_markdown_preview_github == 1
    call system('grip --user=fow5040 --pass=3ae28a00b8a5577e1b570639a88d2f9b778510a5 "' . b:curr_file . '" --export vim-markdown-preview.html --title vim-markdown-preview.html')
  elseif g:vim_markdown_preview_perl == 1
    call system('Markdown.pl "' . b:curr_file . '" > /tmp/vim-markdown-preview.html')
  elseif g:vim_markdown_preview_pandoc == 1
    call system('pandoc --standalone "' . b:curr_file . '" > /tmp/vim-markdown-preview.html')
